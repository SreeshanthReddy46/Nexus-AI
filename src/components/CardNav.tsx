...
const CardNav = ({
  ...
  // Close the expanded nav card menu after clicking on any link
            ...
            >
              ...
              <div className="nav-card-links">
                {item.links?.map((lnk, i) => {
                  const isExternal = lnk.href.startsWith('http') || lnk.href.includes('#');
                  return isExternal ? (
                    <a 
                      key={`${lnk.label}-${i}`} 
                      className="nav-card-link font-sans font-bold" 
                      href={lnk.href} 
